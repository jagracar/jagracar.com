...
<meta name="keywords"
	content="grafica, grafica.js, library, processing, p5.js, java, javaScript, examples">
		...
		<div class="p5js-mainContent">
			...
			<p>
				The library is available in two flavors: the <a
					href="https://github.com/jagracar/grafica">Java version</a> to use
				directly with Processing, and the <a
					href="https://github.com/jagracar/grafica.js">JavaScript
					version</a> to use with <a href="http://p5js.org/">p5.js</a>.
			</p>

			<h2>Main features</h2>

			<ul>
				<li>Make fancy scatter and linear plots that update in real
					time.</li>
				<li>Display histograms in the vertical and horizontal
					directions.</li>
				<li>Add several layers with different properties to the same
					plot.</li>
				...
				<li>It's open source. Grafica is under the <a
					href="https://www.gnu.org/licenses/lgpl.html">GNU Lesser
