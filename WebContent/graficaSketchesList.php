...
<div class="sketches-list">
	...
	<ul>
		<li><a href="<?php echo $homeDir;?>sketches/defaultPlot.php"
			class="<?php if($sketch == 'defaultPlot') { echo $activeSketch; }?>">Default plot</a></li>
		<li><a href="<?php echo $homeDir;?>sketches/exponentialTrend.php"
			class="<?php if($sketch == 'exponentialTrend') { echo $activeSketch; }?>">Exponential trend</a></li>
		<li><a href="<?php echo $homeDir;?>sketches/movingPoints.php"
			class="<?php if($sketch == 'movingPoints') { echo $activeSketch; }?>">Moving points</a></li>
		<li><a href="<?php echo $homeDir;?>sketches/multiplePanels.php"
			class="<?php if($sketch == 'multiplePanels') { echo $activeSketch; }?>">Multiple panels</a></li>
