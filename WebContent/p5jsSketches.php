...
<meta name="keywords"
	content="processing, p5.js, P5js, javaScript, examples">
...
<body>
	...
	<div class=main-container>
		...
		<div class="p5js-mainContent">
			...
			<p>
				<a href="https://processing.org/">Processing</a> is an intuitive and
				very easy to use Java library designed to help artist and students
				to create interactive computer animations.
			</p>

			<p>
				Until very recently, <a
					href="http://en.wikipedia.org/wiki/Java_applet">Java applets</a>
				were the only simple way to include Processing sketches in web pages.
				Unfortunately, during the last couple of years these applets have
				become less and less common in the web. Even some web browsers like
				Chrome do not support them anymore. <a href="http://p5js.org/">P5.js</a>
			...
			<p>
				...
				so feel free to modify them to your needs. You only need to give the
				appropriate credit to the original work and share them with a
