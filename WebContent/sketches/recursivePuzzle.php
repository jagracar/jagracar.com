...
<meta name="keywords"
	content="processing, p5.js, P5js, javaScript, examples, puzzle, recursion, image processing">
...
<body>
				...
				<div class="p5js-sketch__description">
					...
					<p>
						For more details, check the <a
							href="sourceCode/recursivePuzzle.js">source code</a> or play with
						it at <a href="http://jsfiddle.net/jagracar/478qvh4o/">JSFiddle</a>.
					</p>
				</div>
			</div>
		</div>
	...
	<!-- Run the sketch -->
	<script>
	p5Sketch = new p5(recursivePuzzleSketch, "p5js-sketch__canvas");
    </script>
</body>