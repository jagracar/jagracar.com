...
<meta name="keywords"
	content="processing, p5.js, P5js, javaScript, examples, oil painting, simulation">
...
<body>
				...
				<div class="p5js-sketch__description">
					<p>
						...
						from me and my sister). The work by <a
							href="http://www.sergioalbiac.com/">Sergio Albiac</a> was the
					...
					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/82769195?title=0&byline=0&portrait=0"></iframe>
					</div>

					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/82886433?title=0&byline=0&portrait=0"></iframe>
					</div>

					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/84089230?title=0&byline=0&portrait=0"></iframe>
					</div>

					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/82768695?title=0&byline=0&portrait=0"></iframe>
					</div>
					...
					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/82104781?title=0&byline=0&portrait=0"></iframe>
					</div>

					<p>Animations are also posible:</p>

					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/84360699?title=0&byline=0&portrait=0"></iframe>
					</div>

					<div class="video-container">
						<iframe
							src="https://player.vimeo.com/video/84434019?title=0&byline=0&portrait=0"></iframe>
					</div>
	...
	<!-- Run the sketch -->
	<script>
	p5Sketch = new p5(oilPaintingSketch, "p5js-sketch__canvas");
    </script>
</body>